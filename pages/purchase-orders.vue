<template>
    <div class="business-page business-page--list">
        <header class="business-page__header"><div><p class="business-page__eyebrow">ERP · 구매관리</p><h1 class="business-page__title">발주 관리</h1><p class="business-page__desc">구매 발주와 입고 예정 현황을 관리합니다.</p></div><AppButton variant="fill">발주서 작성</AppButton></header>
        ...
        <section class="business-toolbar"><AppInput v-model="keyword" size="sm" placeholder="발주번호, 공급사 검색" /><AppSelect v-model="status" size="sm" :options="statusOptions" placeholder="전체 상태" /><AppButton size="sm" variant="fill">조회</AppButton></section>
