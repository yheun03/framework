<template>
    <div class="business-page business-page--list">
        ...
        <section class="business-toolbar"><AppInput v-model="keyword" class="business-toolbar__field business-toolbar__field--wide" size="sm" placeholder="품목코드 또는 품목명" /><AppSelect v-model="warehouse" class="business-toolbar__field" size="sm" :options="warehouses" placeholder="전체 창고" /><AppChoice v-model="onlyShortage" class="business-toolbar__choice" size="sm" label="부족 재고만" /><div class="business-toolbar__actions"><AppButton size="md" variant="fill">조회</AppButton></div></section>
