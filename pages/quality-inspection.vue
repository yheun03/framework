<template>
    <div class="business-page business-page--list">
        ...
        <section class="business-toolbar"><AppSelect v-model="type" class="business-toolbar__field" size="sm" :options="types" placeholder="검사 구분" /><AppSelect v-model="result" class="business-toolbar__field" size="sm" :options="results" placeholder="전체 판정" /><AppDatePicker v-model="date" class="business-toolbar__field" size="sm" /><div class="business-toolbar__actions"><AppButton size="sm" variant="fill">조회</AppButton></div></section>
