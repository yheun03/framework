    ...
    <div class="page-demo-layout">
      <main class="page-demo-main">
        ...
        <AppSection
          ...
          title="Basic"
          desc="기본적인 line 탭 예시입니다."
        >
          <AppTabs
            :items="basicItems"
            variant="line"
            v-model:active-id="basicActiveId"
          />
        </AppSection>
          ...
          <div class="page-demo-stack">
            <div class="page-demo-stack">
              ...
              <AppTabs
                :items="variantItems"
                variant="line"
                v-model:active-id="lineActiveId"
              />
            </div>
            ...
            <div class="page-demo-stack">
              ...
              <AppTabs
                :items="variantItems"
                variant="pill"
                v-model:active-id="pillActiveId"
              />
            </div>
          </div>
        </AppSection>
        ...
        <AppSection
          class="page-demo-accordion"
          title="Vertical"
          desc="orientation을 vertical로 지정한 좌측 탭 예시입니다."
        >
          <AppTabs
            :items="verticalItems"
        ...
        >
          <AppTabs
            :items="rendererItems"
            variant="line"
            v-model:active-id="rendererActiveId"
          >
