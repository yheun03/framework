...
const summaries: Record<string, DemoSummary> = {
    "demo-button": {
        ...
        props: [
            ...
            { name: "type", description: "button 태그 타입", values: ["button", "submit", "reset"] },
            { name: "to / href", description: "NuxtLink 또는 a 태그 전환" },
            { name: "disabled / loading", description: "클릭 불가와 로딩 상태", values: ["true", "false"] },
        ],
        values: [
            "AppButton",
            "AppTextButton",
    ...
    "demo-input": {
        ...
        props: [
            ...
            { name: "size", description: "입력 필드 높이", values: ["xs", "sm", "md", "lg"] },
            { name: "shape", description: "입력 필드 외곽선 형태", values: ["square", "round", "pill", "underline"] },
            { name: "state", description: "입력 상태", values: ["error", "warning", "success"] },
            { name: "type", description: "input native type", values: ["text", "password", "email", "number"] },
            { name: "clearable / passwordToggle", description: "입력 보조 액션", values: ["true", "false"] },
        ],
    ...
    "demo-grid": {
        ...
        props: [
            ...
            { name: "height / autoHeight", description: "고정 높이 또는 자동 높이" },
            { name: "excelFileName", description: "엑셀 다운로드 파일명" },
        ],
        values: ["input", "select", "calendar", "numberRange"],
    },
    "demo-chart": {
    ...
    "demo-progress": {
        ...
        props: [
            ...
            { name: "label / showValue", description: "라벨과 값 노출 여부", values: ["true", "false"] },
        ],
        values: [
            "AppProgressBar",
            "AppProgressSlider",
    ...
    "demo-datepicker": {
        ...
        props: [
            ...
            { name: "mode", description: "날짜 선택 방식", values: ["single", "range", "multiple"] },
            { name: "minDate / maxDate", description: "선택 가능한 날짜 제한" },
            { name: "size", description: "입력 UI 크기", values: ["xs", "sm", "md", "lg"] },
            { name: "shape", description: "입력 UI 형태", values: ["square", "round", "pill", "underline"] },
            { name: "state", description: "검증 상태", values: ["error", "warning", "success"] },
            { name: "disabled", description: "비활성 제어", values: ["true", "false"] },
        ],
        values: ["single", "range", "multiple", "xs", "sm", "md", "lg", "square", "round", "pill", "underline", "error", "warning", "success"],
    },
    "demo-select": {
        ...
        props: [
            ...
            { name: "size", description: "셀렉트 높이", values: ["xs", "sm", "md", "lg"] },
            { name: "shape", description: "셀렉트 외곽선 형태", values: ["square", "round", "pill", "underline"] },
            { name: "state", description: "검증 상태", values: ["error", "warning", "success"] },
            { name: "required", description: "placeholder 재선택 제한", values: ["true", "false"] },
            { name: "readonly / disabled", description: "읽기 전용과 비활성 상태", values: ["true", "false"] },
        ],
        values: ["xs", "sm", "md", "lg", "square", "round", "pill", "underline", "error", "warning", "success"],
    },
    "demo-choice": {
        description: "checkbox, radio, chip 선택 패턴을 한 컴포넌트로 다룹니다.",
        props: [
            { name: "modelValue / value", description: "선택 상태와 radio option 값" },
            { name: "type", description: "선택 방식", values: ["checkbox", "radio"] },
            { name: "variant", description: "선택 UI 형태", values: ["default", "round", "chip", "chip-outline", "fill", "ghost", "toggle"] },
            { name: "toggleLabels", description: "toggle 전용 checked / unchecked 문구" },
            { name: "size", description: "선택 컴포넌트 크기", values: ["sm", "md"] },
            { name: "state", description: "검증 상태", values: ["error", "warning", "success"] },
            { name: "disabled / readonly", description: "선택 불가와 읽기 전용 상태", values: ["true", "false"] },
        ],
        values: ["checkbox", "radio", "default", "round", "chip", "chip-outline", "fill", "ghost", "toggle", "sm", "md", "error", "warning", "success"],
    },
    "demo-upload-image": {
        description: "이미지 선택, 미리보기, 제거, 읽기 모드를 확인합니다.",
        props: [
            { name: "modelValue", description: "선택된 이미지 파일 또는 목록" },
            { name: "multiple", description: "다중 이미지 선택", values: ["true", "false"] },
            { name: "allowDrop", description: "드래그 앤 드롭 허용 여부", values: ["true", "false"] },
            { name: "accept", description: "허용 파일 형식" },
            { name: "maxSizeBytes / maxCount", description: "파일 용량과 개수 제한" },
            { name: "readMode", description: "이미지 읽기 방식", values: ["dataUrl", "objectUrl"] },
            { name: "disabled", description: "파일 선택 불가 상태", values: ["true", "false"] },
        ],
        values: ["dataUrl", "objectUrl", "image/*"],
    },
    "demo-upload-file": {
        description: "파일 선택, 다중 업로드, 규칙 제한을 확인합니다.",
        props: [
            { name: "modelValue", description: "선택된 파일 또는 파일 목록" },
            { name: "multiple", description: "다중 파일 선택", values: ["true", "false"] },
            { name: "allowDrop", description: "드래그 앤 드롭 허용 여부", values: ["true", "false"] },
            { name: "accept / maxSizeBytes", description: "파일 형식과 용량 제한" },
            { name: "maxCount", description: "다중 선택 최대 개수" },
            { name: "disabled", description: "파일 선택 불가 상태", values: ["true", "false"] },
        ],
        values: ["*/*"],
    },
    "demo-modal": {
        ...
        props: [
            { name: "type", description: "모달 타입", values: ["alert", "confirm", "custom"] },
            { name: "title / message", description: "헤더와 본문 문구" },
            { name: "closeOnEsc", description: "ESC 닫기 허용", values: ["true", "false"] },
            { name: "closeOnBackdrop", description: "배경 클릭 닫기 허용", values: ["true", "false"] },
            { name: "actions", description: "버튼 구성과 콜백" },
        ],
        values: ["alert", "confirm", "custom"],
    },
    "demo-table": {
        ...
        props: [
            ...
            { name: "readonly / disabled", description: "전체 입력 상태 제어", values: ["true", "false"] },
        ],
        values: ["input", "select", "textarea", "choice", "date", "button", "file", "image"],
    },
    "demo-section": {
        description: "업무 화면 섹션의 헤더, 본문, 푸터 영역을 조합합니다.",
        props: [
            { name: "title", description: "섹션 제목" },
            { name: "desc", description: "섹션 보조 설명" },
            { name: "direction", description: "섹션 배치 방향", values: ["column", "row"] },
            { name: "ratio", description: "row 배치 시 컬럼 비율" },
            { name: "gap", description: "섹션 내부 간격" },
        ],
        values: ["column", "row"],
    },
    "demo-accordion": {
        ...
        props: [
            ...
            { name: "mode", description: "열림 방식", values: ["single", "multiple"] },
            { name: "openIds / defaultOpenIds", description: "제어/비제어 열림 값" },
            { name: "initialOpen", description: "초기 열림 상태", values: ["none", "first", "all"] },
        ],
        values: ["single", "multiple", "none", "first", "all"],
    },
    "demo-tabs": {
        description: "탭 목록, 활성 값, 배치와 크기를 확인합니다.",
        props: [
            { name: "items", description: "탭 라벨과 값 배열" },
            { name: "activeId / defaultActiveId", description: "제어/비제어 활성 탭 값" },
            { name: "initialActive", description: "초기 활성 탭 선택 방식", values: ["first", "none"] },
            { name: "variant", description: "탭 표시 스타일", values: ["line", "box", "pill", "vertical"] },
            { name: "size", description: "탭 크기", values: ["sm", "md", "lg"] },
            { name: "stretch", description: "탭 너비 채움", values: ["true", "false"] },
        ],
        values: ["line", "box", "pill", "vertical", "sm", "md", "lg", "first", "none"],
    },
    "demo-form-field": {
        ...
        props: [
            ...
            { name: "required", description: "필수 입력 표시", values: ["true", "false"] },
            { name: "state", description: "필드 상태", values: ["error", "warning", "success"] },
    ...
    "demo-pagination": {
        ...
        props: [
            { name: "page", description: "현재 페이지" },
            { name: "total", description: "전체 아이템 수" },
            { name: "pageSize", description: "페이지당 아이템 수" },
            { name: "pageSizeOptions", description: "페이지당 개수 옵션" },
            { name: "siblingCount", description: "현재 페이지 주변 노출 수" },
            { name: "size", description: "페이지네이션 크기", values: ["sm", "md"] },
            { name: "showTotal / showPageSize", description: "전체 수와 페이지 크기 영역 표시", values: ["true", "false"] },
            { name: "disabled", description: "페이지 이동 비활성", values: ["true", "false"] },
        ],
        values: ["sm", "md"],
    },
    "demo-textarea": {
        ...
        props: [
            ...
            { name: "size", description: "Textarea 크기", values: ["sm", "md", "lg"] },
            { name: "resize", description: "리사이즈 방향", values: ["none", "vertical", "horizontal", "both"] },
            { name: "disabled / readonly", description: "입력 가능 상태", values: ["true", "false"] },
        ],
