...
const summaries: Record<string, DemoSummary> = {
    ...
    "demo-chart": {
        ...
        props: [
            { name: "type", description: "line, bar, doughnut, semi-doughnut, pie 타입" },
    ...
    "demo-progress": {
        ...
        props: [
            ...
            },
            {
                ...
                description: "gauge, semi-doughnut-range 표시 타입",
            },
            {
                name: "mode",
    ...
    "demo-datepicker": {
        ...
        props: [
            ...
            { name: "mode", description: "single, range, multiple 선택 방식" },
    ...
    "demo-upload-image": {
        ...
        props: [
            ...
            { name: "allowDrop", description: "드래그 앤 드롭 허용 여부" },
            { name: "accept", description: "허용 파일 형식" },
            { name: "maxSizeBytes / maxCount", description: "파일 용량과 개수 제한" },
            { name: "readMode", description: "dataUrl, objectUrl 읽기 방식" },
    ...
    "demo-section": {
        ...
        props: [
            ...
            { name: "direction", description: "column, row 배치 방향" },
    ...
    "demo-accordion": {
        ...
        props: [
            ...
            { name: "mode", description: "single, multiple 열림 방식" },
    ...
    "demo-tabs": {
        ...
        props: [
            ...
            { name: "initialActive", description: "first, none 초기 활성 탭 선택 방식" },
            { name: "variant", description: "line, box, pill, vertical 스타일" },
            { name: "size", description: "sm, md, lg 크기" },
            { name: "stretch", description: "탭 너비 채움" },
        ],
