      ...
      <main class="page-demo-main">
        ...
        >
          <div class="page-demo-stack">
            <AppProgressBar
              :value="linearDisplayValue"
              label="단일 값"
              show-value
            />

            <AppProgressBar
              :range="linearRangeDisplay"
              label="범위 값"
              show-value
            />
        ...
        >
          <div class="page-demo-stack">
            <AppProgressSlider
              v-model:value="linearControlValue"
              label="단일 값"
              show-value
            />
        ...
        >
          <div class="page-demo-grid">
            ...
            <AppProgressGauge
              :range="gaugeRangeDisplay"
              type="semi-doughnut-range"
              label="권장 범위"
            />
          </div>
        </AppSection>
        ...
        >
          <div class="page-demo-grid">
            <AppProgressGauge
              v-model:value="gaugeControlValue"
              type="gauge"
              mode="control-single"
              label="속도"
            />
        ...
        >
          <div class="page-demo-grid">
            <AppProgressSlider
              :value="disabledLinearValue"
              label="Disabled Linear"
              show-value
              disabled
            />

            <AppProgressGauge
              :value="disabledGaugeValue"
              type="gauge"
              mode="control-single"
              label="Disabled Gauge"
              disabled
            />
          </div>
        </AppSection>
