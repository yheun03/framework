      ...
      <main class="page-demo-main">
          ...
          <div class="page-demo-stack">
            <div class="page-demo-compare">
              ...
              <div class="page-demo-row">
                ...
                />
                <AppChoice
                  v-model="checkbox.aMd.checkedDisabled"
                  type="checkbox"
                  uiType="a"
                  size="md"
                  label="체크 비활성화"
            ...
            <div class="page-demo-compare">
              ...
              <div class="page-demo-row">
                ...
                />
                <AppChoice
                  v-model="checkbox.aSm.checkedDisabled"
                  type="checkbox"
                  uiType="a"
                  size="sm"
                  label="체크 비활성화"
            ...
            <div class="page-demo-compare">
              ...
              <div class="page-demo-row">
                ...
                />
                <AppChoice
                  v-model="checkbox.bMd.checkedDisabled"
                  type="checkbox"
                  uiType="b"
                  size="md"
                  label="체크 비활성화"
            ...
            <div class="page-demo-compare">
              ...
              <div class="page-demo-row">
                ...
                />
                <AppChoice
                  v-model="checkbox.bSm.checkedDisabled"
                  type="checkbox"
                  uiType="b"
                  size="sm"
                  label="체크 비활성화"
          ...
          <div class="page-demo-stack">
            <div class="page-demo-compare">
              ...
              <div class="page-demo-row">
                ...
                />
                <AppChoice
                  v-model="radioDisabled.aMd"
                  type="radio"
                  name="radio-a-md-disabled"
                  value="default"
                  uiType="a"
                  size="md"
                  label="비활성화"
                ...
                />
                <AppChoice
                  v-model="radioDisabledChecked.aMd"
                  type="radio"
                  name="radio-a-md-disabled-checked"
                  value="checked"
                  uiType="a"
                  size="md"
                  label="체크 비활성화"
            ...
            <div class="page-demo-compare">
              ...
              <div class="page-demo-row">
                ...
                />
                <AppChoice
                  v-model="radioDisabled.aSm"
                  type="radio"
                  name="radio-a-sm-disabled"
                  value="default"
                  uiType="a"
                  size="sm"
                  label="비활성화"
                ...
                />
                <AppChoice
                  v-model="radioDisabledChecked.aSm"
                  type="radio"
                  name="radio-a-sm-disabled-checked"
                  value="checked"
                  uiType="a"
                  size="sm"
                  label="체크 비활성화"
            ...
            <div class="page-demo-compare">
              ...
              <div class="page-demo-row">
                ...
                />
                <AppChoice
                  v-model="radioDisabled.bMd"
                  type="radio"
                  name="radio-b-md-disabled"
                  value="default"
                  uiType="b"
                  size="md"
                  label="비활성화"
                ...
                />
                <AppChoice
                  v-model="radioDisabledChecked.bMd"
                  type="radio"
                  name="radio-b-md-disabled-checked"
                  value="checked"
                  uiType="b"
                  size="md"
                  label="체크 비활성화"
            ...
            <div class="page-demo-compare">
              ...
              <div class="page-demo-row">
                ...
                />
                <AppChoice
                  v-model="radioDisabled.bSm"
                  type="radio"
                  name="radio-b-sm-disabled"
                  value="default"
                  uiType="b"
                  size="sm"
                  label="비활성화"
                ...
                />
                <AppChoice
                  v-model="radioDisabledChecked.bSm"
                  type="radio"
                  name="radio-b-sm-disabled-checked"
                  value="checked"
                  uiType="b"
                  size="sm"
                  label="체크 비활성화"
        ...
        >
          <div class="page-demo-stack">
            <div class="page-demo-row">
              <AppChoice
                v-model="chipFilter.development"
                type="checkbox"
                variant="chip"
                label="개발"
              />
              <AppChoice
                v-model="chipFilter.design"
                type="checkbox"
                variant="chip"
                label="디자인"
              />
              <AppChoice
                v-model="chipFilter.planning"
                type="checkbox"
                variant="chip"
                label="기획"
              />
            ...
            <div class="page-demo-row">
              <AppChoice
                v-model="chipFilter.outlineA"
                type="checkbox"
                variant="chip-outline"
                label="Outline A"
              />
              <AppChoice
                v-model="chipFilter.outlineB"
                type="checkbox"
                variant="chip-outline"
                label="Outline B"
              />
        ...
        >
          <div class="page-demo-stack">
            ...
            <div class="page-demo-row">
              <AppChoice
                v-model="disabled.radio"
                type="radio"
                name="disabled-plan"
                value="basic"
                label="Disabled Radio A"
                hint="선택 불가"
                disabled
              />
            ...
            <div class="page-demo-row">
              ...
              <AppChoice
                v-model="disabledChip.fill"
                type="radio"
                name="disabled-chip-radio"
                value="option-a"
                variant="fill"
                label="Disabled Fill A"
                disabled
              />
