    ...
    <div class="page-demo">
        <div class="page-demo-layout">
            <main class="page-demo-main">
                ...
                <!-- REQUIRED -->
                <AppSection class="page-demo-accordion" title="Required" desc="required 상태에서는 label 옆에 필수 표시가 노출됩니다.">
                ...
                <!-- OPTIONAL -->
                <AppSection class="page-demo-accordion" title="Optional" desc="optionalText로 선택 입력 필드를 표시할 수 있습니다.">
                ...
                <!-- ERROR -->
                <AppSection class="page-demo-accordion" title="Error" desc="error가 있으면 hint 대신 error message가 표시됩니다.">
                ...
                <!-- SLOT LABEL -->
                <AppSection class="page-demo-accordion" title="Label Slot" desc="label slot으로 커스텀 라벨을 렌더링할 수 있습니다.">
