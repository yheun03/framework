const En = {
    ...
    'nav.business.erpDashboard': 'ERP Dashboard',
    'nav.business.salesOrders': 'Sales Orders',
    'nav.business.salesOrderDetail': 'Sales Order Detail',
    'nav.business.purchaseOrders': 'Purchase Orders',
    'nav.business.inventoryStatus': 'Inventory Status',
    'nav.business.productionPlan': 'Production Plan',
    'nav.business.workOrders': 'Work Orders',
    'nav.business.workOrderDetail': 'Work Order Detail',
    'nav.business.qualityInspection': 'Quality Inspection',
    'nav.business.equipmentMonitoring': 'Equipment Monitoring',
    ...
    'demo.progress.desc': 'Linear and Gauge progress components with display and drag-control types.',
    'demo.datepicker.title': 'AppDatePicker',
    'demo.datepicker.desc': 'Flatpickr-based DatePicker supporting type, size, shape, state, disabled, min, and max.',
