const Ko = {
    ...
    'nav.demos': '데모',
    'nav.settings': '설정',
    'nav.businessDemos': 'ERP · MES 예제',
    'nav.business.erpDashboard': '경영 현황 대시보드',
    'nav.business.salesOrders': '수주 목록',
    'nav.business.salesOrderDetail': '수주 상세',
    'nav.business.purchaseOrders': '발주 관리',
    'nav.business.inventoryStatus': '재고 현황',
    'nav.business.productionPlan': '생산계획',
    'nav.business.workOrders': '작업지시 목록',
    'nav.business.workOrderDetail': '작업지시 상세',
    'nav.business.qualityInspection': '품질검사 현황',
    'nav.business.equipmentMonitoring': '설비 모니터링',
