const Ko = {
  ...
  "demo.input.desc":
    "Text 입력을 위한 기본 Input 컴포넌트입니다. size / shape / icon / state / disabled / readonly 상태를 지원합니다.",
  "demo.grid.title": "AG Grid Demo",
  "demo.grid.desc": "AppGridToolbar 기반 Grid UI 패턴",
  "demo.chart.title": "AppChart",
  "demo.chart.desc":
    "Chart.js 기반 차트 컴포넌트입니다. line / bar / doughnut / semi-doughnut / pie 타입을 지원합니다.",
  "demo.progress.title": "AppProgress",
  "demo.progress.desc":
    "Linear Progress와 Gauge Progress 컴포넌트입니다. display / drag control 형태를 지원합니다.",
  "demo.datepicker.title": "AppDatePicker",
  "demo.datepicker.desc":
    "Flatpickr 기반 DatePicker 컴포넌트입니다. mode / size / shape / state / disabled / min / max 속성을 지원합니다.",
  "demo.select.title": "AppSelect",
  "demo.select.desc":
    "옵션 선택을 위한 기본 Select 컴포넌트입니다. size / shape / state / disabled 상태를 지원합니다.",
  "demo.choice.title": "AppChoice",
  "demo.choice.desc":
    "checkbox / radio / chip 계열 선택 컴포넌트입니다. 자주 쓰는 패턴 기준 조합을 확인할 수 있습니다.",
  "demo.uploadImage.title": "Image Field Demo",
  "demo.uploadImage.desc":
    "이미지 업로드/미리보기/제거 및 change 이벤트를 확인합니다.",
  "demo.uploadFile.title": "File Upload Demo",
  "demo.uploadFile.desc":
    "일반 파일 업로드/삭제/다중 선택 및 change 이벤트를 확인합니다.",
  "demo.modal.title": "Modal Demo",
  "demo.modal.desc":
    "Alert / Confirm / Custom 모달과 스택(ESC/배경/X) 동작을 확인합니다.",
  ...
  "demo.section.desc":
    "AppSection 컴포넌트의 모든 속성을 한 화면에서 확인합니다.",
  "demo.accordion.title": "AppAccordion",
  "demo.accordion.desc":
    "AppAccordion 컴포넌트의 모든 속성을 한 화면에서 확인합니다.",
  ...
  "demo.pagination.desc":
    "AppPagination 컴포넌트의 모든 속성을 한 화면에서 확인합니다.",
  "demo.textArea.title": "AppTextarea",
  "demo.textArea.desc":
    "AppTextarea 컴포넌트의 모든 속성을 한 화면에서 확인합니다.",
};
