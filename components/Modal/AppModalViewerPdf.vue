    ...
    <div class="app-pdf-viewer">
        <div v-if="sourceUrl" class="app-pdf-viewer__toolbar">
            <div class="app-pdf-viewer__pager">
                <AppButton variant="outline" size="sm" :disabled="isBusy || pageNumber <= 1"
            ...
            <div class="app-pdf-viewer__zoom">
                <AppButton variant="outline" size="sm" :disabled="isBusy || scale <= minScale" @click="handleZoomOut">
                    축소
                </AppButton>
                ...
                <AppButton variant="outline" size="sm" :disabled="isBusy || scale >= maxScale" @click="handleZoomIn">
                    확대
                </AppButton>
            </div>
        </div>
