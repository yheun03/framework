...
const controlSizeMap: Record<IconButtonSize, number> = {
    xs: 24,
    sm: 28,
    md: 32,
    lg: 36,
...
const styles = computed(() => ({
    '--icon-button-size': sizeToCss(props.size, controlSizeMap),
...
const mergedStyles = computed(() => [attrs.style as string | Record<string, string> | undefined, syncedSizeStyles.value, styles.value]);
