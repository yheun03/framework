  ...
  <div :class="rootClasses">
    <div class="app-progress-gauge__svg-wrap">
      ...
      >
        <!-- track -->
        <path
          class="app-progress-gauge__track"
          :d="trackPath"
        ...
        <path
          v-if="hasRange"
          class="app-progress-gauge__range"
          :d="rangePath"
          :stroke-width="strokeWidth"
        />
        ...
        <path
          v-if="isGauge"
          class="app-progress-gauge__value"
          :d="valuePath"
          :stroke-width="strokeWidth"
        />
        ...
        <circle
          v-if="showValueNeedle"
          class="app-progress-gauge__needle-center"
          :cx="center.x"
          :cy="center.y"
          r="3.5"
        />
      ...
      <div v-if="showContent" class="app-progress-gauge__content">
        ...
        <div
          v-if="showRangeText && hasRange"
          class="app-progress-gauge__range-text"
        >
...
const isControlRange = computed(
  () => props.mode === "control-range" && hasRange.value,
);

const showValueNeedle = computed(() => isGauge.value && props.showNeedle);
const showRangeHandles = computed(() => isControlRange.value);
const showContent = computed(
  () => props.showLabel || props.showValue || props.showRangeText,
);
